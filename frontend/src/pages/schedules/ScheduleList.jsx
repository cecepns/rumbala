...
export default function ScheduleList() {
  ...
  const handleOpenCreate = () => {
    ...
    setFormData({
      ...
      program_name: firstStudent?.programs?.[0]?.program_name || programs[0]?.name || "Pracalis",
      ...
      end_time: "17:00",
      duration_minutes: 90,
      subject: firstStudent?.programs?.[0]?.program_name || "Pracalis",
      location_type: "offline",
      is_home_visit: 0,
  ...
  const handleOpenEdit = (sc) => {
    ...
    setFormData({
      ...
      program_name: sc.program_name || "Pracalis",
